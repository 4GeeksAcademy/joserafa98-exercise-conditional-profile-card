...
function render(variables = {}) {
  ...
  let positionClass =
    variables.socialMediaPosition === "position-right"
      ? "position-right"
      : "position-left";
  let twitterUser = `${variables.twitter || "Twitter"}`;
  let githubUser = `${variables.github || "Git hub"}`;
  let linkedinUser = `${variables.linkedin || "Linkedin"}`;
  let instagramUser = `${variables.instagram || "instagram"}`;
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <ul class="${positionClass}">
            ...
            <li><a href="https://linkedin.com/${linkedinUser}"><i class="fab fa-linkedin"></i></a></li>
